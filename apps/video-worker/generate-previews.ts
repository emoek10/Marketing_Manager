...
function generatePreview(platform: string, safeTitle: string, textTop: string, outputFilename: string) {
    ...
    const outputPathLocal = path.join(artifactDir, outputFilename);
